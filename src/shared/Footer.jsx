            ...
            <footer className="bg-base-200">
                <div className="max-w-7xl mx-auto">
                    <div className="flex lg:flex-row flex-col gap-5 p-10 text-base-content">
                        <nav className='max-w-xs flex flex-col gap-3'>
                            <Link><img src={logo} className='max-w-52' alt="" /></Link>
                            <p className='leading-loose'>Sedut perspiciatis unde omnis iste natus error sitlutem acc usantium doloremque denounce with illo inventore veritatis</p>
                        </nav>
                        ...
                        <form className='flex flex-col gap-2'>
                            ...
                            <fieldset className="form-control max-w-80">
                                <label className="">
                                    <span className="">We denounce with righteous and in and dislike men who are so beguiled and demo realized.</span>
                                </label>
                                <div className="join">
